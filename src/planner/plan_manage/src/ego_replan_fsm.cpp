...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    formation_pos_ << pos[0], pos[1], kPlanarZ;
    nh.getParam("formation/start", pos);
    formation_start_ << pos[0], pos[1], kPlanarZ;
  ...
  {
    Eigen::Vector3d next_wp(msg->pose.position.x, msg->pose.position.y, kPlanarZ);
